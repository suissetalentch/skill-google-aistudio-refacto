...
Refactor React/TypeScript frontend code generated by Google AI Studio to production-grade conventions. Detects and fixes 25 systematic anti-patterns with an automated scan-fix-verify loop.
...
## What It Fixes (25 Anti-Patterns)
...
| P0 | **Security** | API key in client bundle, `.env` not in `.gitignore`, prompts mixed in code, axios (use fetch) |
